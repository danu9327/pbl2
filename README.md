...
###### [0] bicycle       risk_weight=0.6
###### [1] kickboard     risk_weight=0.7
###### [2] bollard       risk_weight=0.5
###### [3] car           risk_weight=0.9
###### [4] motorcycle    risk_weight=0.8
###### [5] stairs        risk_weight=0.7
###### [6] crosswalk     risk_weight=0.3
###### [7] people        risk_weight=0.4
---
